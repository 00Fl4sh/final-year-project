...
function SemiCircleProgressBar({ percent }) {
  ...
  return (
    ...
    <br/>
    <h5 style={{marginLeft:"80px",color:"teal"}}>Low levels of Symptoms seen in depression</h5>
    ...
    <div style={{marginLeft:"790px",color:"teal", marginBottom:'0px',marginTop:'-300px' }} >
